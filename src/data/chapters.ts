...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    story: [
      ...
      'Planned enhancements apply established UX heuristics: SpeedDial for contact uses Fitts\'s Law (frequently used actions should be easily reachable). Autocomplete filtering leverages recognition over recall—users see available tags rather than guessing search terms. Stepper components for case studies provide progress indicators, reducing uncertainty about content length.',
    ...
    milestones: [
      ...
      { version: 'v2.4.0', title: 'Design System (Storybook component library)', status: 'in-progress' },
      { version: 'v2.5.0', title: 'Contact & Engagement (SpeedDial, analytics)', status: 'planned' },
      { version: 'v2.6.0', title: 'Content Depth (Case studies, Stepper/Tabs)', status: 'planned' },
      { version: 'v2.7.0', title: 'Discoverability (Autocomplete filtering)', status: 'planned' },
    ],
  },
  {
    id: 'chapter-4',
    title: 'Chapter 4: Content Platform',
    status: 'planned',
    versions: 'v3.0.0',
    story: [
      'The final transformation: from static portfolio to living knowledge base. A portfolio shows what you\'ve done; a blog shows how you think. The distinction matters for roles where problem-solving process matters as much as outcomes.',
      'MDX enables embedded interactivity—code examples users can run, diagrams they can explore—moving beyond passive reading toward active learning. This supports varied learning styles and increases time-on-site through genuine engagement rather than dark patterns.',
      'RSS feeds serve power users who prefer consuming content through their existing workflows. It\'s a small gesture of respect for user autonomy—meeting people where they are rather than demanding they come to you.',
    ],
    milestones: [
