...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    story: [
      ...
      'The MDX Blog (v2.5.0) transforms the portfolio from static showcase to living knowledge base. A portfolio shows what you\'ve done; a blog shows how you think. MDX enables embedded interactivity—code examples users can run, diagrams they can explore. The first use case: documenting the orbit-lab development journey in real-time.',
      'orbit-lab (v2.6.0) represents a new direction—building reusable visualization frameworks. A 3D globe built with React Three Fiber and three-globe, deployed separately on Vercel, but linked as a portfolio piece. The blog documents the journey; the portfolio showcases the result.',
    ...
    milestones: [
      ...
      { version: 'v2.6.0', title: 'orbit-lab Portfolio Card (3D globe visualization)', status: 'in-progress' },
