...
export const updates: Update[] = [
  ...
  },
  {
    ...
    date: 'TBD',
    version: '2.6.0',
    title: 'orbit-lab Portfolio Card',
    description: 'Add orbit-lab 3D globe visualization project to portfolio.',
    category: 'feature',
    status: 'in-progress',
    tags: ['Three.js', 'React Three Fiber', 'WebGL', '3D', 'Portfolio'],
    details: [
      'Portfolio card linking to orbit-lab on Vercel',
  ...
  // In Progress
  {
    ...
    details: [
      ...
      'RSS feed generation',
      'First post: documenting orbit-lab development journey',
    ],
  },
  {
    id: 'v2.4.0',
