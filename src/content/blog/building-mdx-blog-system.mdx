...
| v2.5.0 | orbit-lab-project | Building a 3D flight tracker |
| v2.6.0 | MDX Blog | This post |
...
![Before: Site navigation without Blog](/images/blog/building-mdx-blog-system/01-before-home.jpg)

### After: Blog Integrated

Now "Blog" appears in navigation, and each post connects to its version in Site Evolution.

![After: Site navigation with Blog](/images/blog/building-mdx-blog-system/02-after-home.jpg)
